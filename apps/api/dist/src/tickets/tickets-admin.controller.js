...
exports.TicketsAdminController = void 0;
...
let TicketsAdminController = class TicketsAdminController {
    ...
    async list(status, page, pageSize) {
        const normalizedStatus = status && ['open', 'pending', 'resolved'].includes(status)
            ? status
            : undefined;
...
exports.TicketsAdminController = TicketsAdminController;
__decorate([
    (0, common_1.Get)(),
...
//# sourceMappingURL=tickets-admin.controller.js.map